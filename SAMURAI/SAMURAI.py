...
vipro = LINETCR.LINE()
vipro.login(token='EulKHqWYqpqcfKOOe9Y1.F0ABpLeoRsEKFrgjk8Jvaq.C53Q7+KhVnz7yGp2ld6vYx/bPgybvPtynGd48Qi2KBY=')
vipro.loginResult()
...
Bots=[mid]
Creator=["u4ddbf27ba4a0c3adc4c55e16ce1a0302", "u7f469b3e510ead27a47d11892bc8d501"]
admin=["u4ddbf27ba4a0c3adc4c55e16ce1a0302", "u7f469b3e510ead27a47d11892bc8d501"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By : SAMURAI\nContact Me : 👉 line.me/ti/p/ricco1311",    
    "commentOn":True,
    "commentBlack":{},
    "message":"Thx For Add Me (^_^)\nKalau Ada Perlu Jangan Sungkan Untuk PM Yah Sob ヘ(^_^)ヘ",    
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Qr":False,
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = vipro.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Dont Tag!! Lagi Sibuk Anu",cName + " Ngapain Ngetag? Kangen Yah hihihi?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Tembak Aja","Dia Lagi Nanggung", cName + " Kenapa Tag Saya?","Lagi Tidur\nJangan Di Tag " + cName, "Jangan Suka Tag Gue " + cName, "Kamu Siapa " + cName + "?", "Ada Perlu Apa " + cName + "?","Woii " + cName + " Jangan Ngetag, lagi Modol!"]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention2"] == True:          
                    contact = vipro.getContact(msg.from_)
                    cName = contact.displayName
                    balas = ["Sekali lagi nge tag gw sumpahin Masuk Syurga!","Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja","Woii " + cName + " Jangan Ngetag, Riibut!"]
                    ret_ = random.choice(balas)
                    name = re.findall(r'@(\w+)', msg.text)
                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                    mentionees = mention['MENTIONEES']
